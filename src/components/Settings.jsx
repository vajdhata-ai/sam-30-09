        ...
        <div className={`h-full overflow-y-auto custom-scrollbar-thin p-6 md:p-10 pb-32 bg-transparent`}>
            <div className="max-w-3xl mx-auto">
                <header className="mb-10">
                    ...
                    <p className="text-theme-muted text-sm uppercase tracking-widest font-bold">Customize your Samvada experience</p>
                </header>
                ...
                <SettingsSection title="Appearance" icon={Eye} isDark={isDark}>
                    <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 border border-theme-border/50 p-4 rounded-3xl bg-theme-bg">
                            ...
                            <ThemeOption themeKey={THEMES.OLIVE} label="Olive Green (Army)" colorClass="from-[#556b2f] to-[#8fbc8f]" isDark={isDark} onClick={() => handleThemeChange(THEMES.OLIVE)} />
                            ...
                            <ThemeOption themeKey={THEMES.AIR_FORCE} label="Sky Blue (Air Force)" colorClass="from-[#87ceeb] to-[#4682b4]" isDark={isDark} onClick={() => handleThemeChange(THEMES.AIR_FORCE)} />
                        </div>
                    </div>
                </SettingsSection>
